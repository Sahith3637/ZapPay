...
public partial class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__AuditLog__5E548648E986D3DC");
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__BankAcco__349DA5A6ED6875B1");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E129A8EB024");
        ...
        {
            entity.HasKey(e => e.Otpid).HasName("PK__OTPVerif__5C2EC4823CCCCC83");
        ...
        {
            entity.HasKey(e => e.QrcodeId).HasName("PK__QRCodeDe__62FECD92773FD50C");
        ...
        {
            entity.HasKey(e => e.SystemUserId).HasName("PK__SystemUs__8788C295745FB76A");
        ...
        {
            entity.HasKey(e => e.TransactionId).HasName("PK__Transact__55433A6BCCAF6897");
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__Transact__5E548648EA8E8B75");
        ...
        {
            entity.HasKey(e => e.MandateId).HasName("PK__UPIManda__A5A5EC654A41F8B0");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CC4CA8092BC3");
        ...
        {
            entity.HasKey(e => e.Kycid).HasName("PK__UserKYC__4ED3C4C9FC2C450E");
        ...
        {
            entity.HasKey(e => e.SessionId).HasName("PK__UserSess__C9F49290E487B185");
        ...
        {
            entity.HasKey(e => e.Vpaid).HasName("PK__VirtualP__3A2D0D5BBFF2D802");
